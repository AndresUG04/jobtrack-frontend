        ...
        <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
          <div className="relative sm:max-w-xs sm:flex-1">
            ...
            <input
              ...
              className="block w-full rounded-lg border-0 bg-white py-2 pl-9 pr-3 text-sm text-slate-900 ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-600"
            />
          </div>
                ...
                {applications.map((app) => (
                  ...
                  >
                    <td className="px-5 py-3">
                      ...
                      <div className="text-slate-500">{app.position}</div>
                    </td>
                    <td className="px-5 py-3">
